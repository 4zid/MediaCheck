...
export function Masthead() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-surface/80 backdrop-blur-2xl border-b border-fg/[0.06]">
      <div className="max-w-6xl mx-auto px-5">
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="font-headline text-[15px] font-bold tracking-tight text-fg/90 group-hover:text-fg transition-colors">
              mediacheck
            </span>
          </Link>
              ...
              return (
                <Link
                  ...
                  className={`px-3.5 py-1.5 rounded-lg text-[13px] font-medium transition-all duration-200 ${
                    active
                      ? 'bg-fg/[0.08] text-fg'
                      : 'text-fg/40 hover:text-fg/70 hover:bg-fg/[0.04]'
                  }`}
                >
                  {label}
                </Link>
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg text-fg/30 hover:text-fg/60 hover:bg-fg/[0.04] transition-all duration-200"
